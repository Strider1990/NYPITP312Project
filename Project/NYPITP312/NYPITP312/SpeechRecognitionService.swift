...
let API_KEY : String = "AIzaSyAqltysA3utQQ8WEr-zHExEUSZR3NNJ35o"
...
class SpeechRecognitionService {
    ...
    func streamAudioData(_ audioData: NSData, completion: @escaping SpeechRecognitionCompletionHandler) {
        if (!streaming) {
            ...
            // var data : [SpeechContext] = ["Bedok", "Ang Mo Kio", "Toa Payoh", "Paya Lebar"]
            //   var phrase = [SpeechContext]()
            
            //  phrase.phrasesArray = ["Bedok", "Ang Mo Kio", "Toa Payoh", "Paya Lebar"]
            ...
            //        recognitionConfig.speechContextsArray = phrase as! NSMutableArray
            //            recognitionConfig.speechContextsArray = [SpeechContext]() as! NSMutableArray
            
            //                [phrase.phrasesArray{
            //                ["Bedok", "Ang Mo Kio", "Toa Payoh", "Paya Lebar"]
            //                }]
